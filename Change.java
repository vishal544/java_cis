...
public class Change
{
  ...
  public static void main(String args[])
  {
    ...
    Scanner input=new Scanner(System.in);
     ...
     System.out.printf("dollars is %.2d\n",dollars);// display dollars

     System.out.printf("quarters is %.2d\n",quarters);// display quarters

     System.out.printf("dimes is %.2d\n",dimes);//display dimes

     
     System.out.printf("nickels is %.2d\n",nickels);//display nickels

     
     System.out.printf("pennies is %.2d\n",pennies);//display pennies
